...
<section>
  <div class="container">
    <div class="flex-sm-row">
      <div class="p-2">
        <div class="jumbotron" id="jumbotron-message-home">
                    <h1>Analogues message</h1>
                    <p class="lead text-justify">
                          We have made available a new version of the package in a GitHub repository. This
                        version of the package has the same capabilities of the online version, but you would have to
                        use through R. The repository is here <a
                            href="http://github.com/CIAT-DAPA/analogues" target="_blank">http://github.com/CIAT-DAPA/analogues</a>. Do
                        check the
                        README file, as it will tell you how to install it in your computer. It also contains a simple
                        example. Sometime within this year we’ll develop an R shiny that can be called from R locally,
                        to facilitate use. But at this point the R package is the only option that exists. While not
                        ideal, we hope that this will serve at least some of our users.
                    </p>
                </div>
